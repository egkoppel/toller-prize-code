...
# recover completely in random time between 7 and 12 timesteps
...
def main():
	...
	cells_to_image(cells, "out/time_tracked/0.png")
	for i in range(0,200):
		cells, count = timestep(cells, i)
		counts.append(count)
		cells_to_image(cells, f"out/time_tracked/{i+1}.png")
	
	fig, ax = plt.subplots()
	ax.plot(counts)
	ax.set_ylabel("Number of people")
	fig.legend(("S", "I", "R"))
	plt.savefig("graphs/time_tracked.png")
	plt.show()
